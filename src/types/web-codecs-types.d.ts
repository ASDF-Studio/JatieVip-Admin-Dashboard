...
interface ImageDecoderInit {
  ...
  interface CanvasDrawImage {
    drawImage(image: CanvasImageSource | VideoFrame, dx: number, dy: number): void
    drawImage(image: CanvasImageSource | VideoFrame, dx: number, dy: number, dw: number, dh: number): void
    drawImage(
