...
export const country = [
    ...
    { value: 'Antigua and', label: 'Antigua and Barbuda' },
    ...
    { value: 'British Indian', label: 'British Indian Ocean Territory' },
    ...
    { value: 'Cocos (Keeling', label: 'Cocos (Keeling) Islands' },
    ...
    { value: 'French Southern', label: 'French Southern Territories' },
    ...
    { value: 'Heard Island', label: 'Heard Island and McDonald Mcdonald Islands' },
    ...
    { value: 'Isle of', label: 'Isle of Man' },
    ...
    { value: 'Lao People', label: "Lao People's Democratic Republic" },
    ...
    { value: 'Northern Mariana', label: 'Northern Mariana Islands' },
    ...
    { value: 'Papua New', label: 'Papua New Guinea' },
    ...
    { value: 'Saint Helena', label: 'Saint Helena, Ascension and Tristan da Cunha' },
    { value: 'Saint Kitts', label: 'Saint Kitts and Nevis' },
    { value: 'Saint Lucia', label: 'Saint Lucia' },
    { value: 'Saint Martin', label: 'Saint Martin (French part)' },
    { value: 'Saint Pierre', label: 'Saint Pierre and Miquelon' },
    ...
    { value: 'Svalbard and', label: 'Svalbard and Jan Mayen' },
    { value: 'Swaziland', label: 'Swaziland' },
    { value: 'Sweden', label: 'Sweden' },
    { value: 'Switzerland', label: 'Switzerland' },
    { value: 'Syrian Arab', label: 'Syrian Arab Republic' },
    ...
    { value: 'Trinidad and', label: 'Trinidad and Tobago' },
    { value: 'Tunisia', label: 'Tunisia' },
    { value: 'Turkey', label: 'Turkey' },
    { value: 'Turkmenistan', label: 'Turkmenistan' },
    { value: 'Turks and', label: 'Turks and Caicos Islands' },
