...
export const BoxSelect: FC<Props> = ({ onChange = undefined, data }): ReactElement => {
        ...
        data.map(({ title, value, discountValue = null }, index) => {
          return (
            <div
              ...
              className={`w-[18.75rem] h-[6.25rem] bg-primary-white rounded-[24px] flex gap-[1.188rem] items-center pl-[2.125rem] hover:cursor-pointer ${
