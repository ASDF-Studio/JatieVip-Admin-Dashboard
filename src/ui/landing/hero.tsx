...
export const HeroSection: React.FC = (): React.ReactElement => {
  return (
    <div className="relative flex">
      ...
      <div className="max-w-[420px] px-5 flex flex-col justify-end sm:block w-full mx-auto mt-[92.5px] relative sm:max-w-[768px] sm:px-[41.5px] sm:mt-[81px] x:max-w-[1024px] x:px-[61.3px] x:mt-[81px] xl:px-0 xl:max-w-[900px] xl:mt-[80.5px] 2xl:max-w-[995px] min-h-[830px] sm:min-h-[726px] xl:min-h-[718px] 2xl:min-h-[840px] overflow-hidden ">
        <img
        ...
        <div className="flex flex-col gap-[24.5px] sm:gap-[28px] xl:gap-4 mt-0 sm:mt-[220px] sm:ml-[291px] x:ml-[382px] x:mt-[241px] xl:ml-[382px] xl:mt-[233px] mb-[135px] sm:mb-0">
