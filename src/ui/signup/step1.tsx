      ...
      <div className="w-full x:w-[447px] mx-auto flex-col">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2.5 x:gap-4">
            <Typography className="ml-[7px] text-[16px] font-semibold">Already have an account?</Typography>
            <Button onClick={() => navigateTo('/login')} className="bg-[#e3f2f7]" variant="landingButton">
              Login
            </Button>
          </div>
        </div>
